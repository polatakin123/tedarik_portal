<?php
// header.php - Admin paneli için ortak başlık
if (!isset($_SESSION)) {
    session_start();
}

// Giriş kontrolü
if (!isset($_SESSION['giris']) || $_SESSION['giris'] !== true || $_SESSION['rol'] !== 'Admin') {
...
<head>
    ...
    <title><?= $page_title ?? 'Admin Paneli' ?> - Tedarik Portalı</title>
    ...
    <nav class="sidebar" id="sidebar">
        ...
        <div class="sidebar-sticky">
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link <?= $current_page == 'tedarikciler.php' ? 'active' : '' ?>" href="tedarikciler.php">
                        <i class="bi bi-building"></i> Tedarikçiler
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?= $current_page == 'kullanicilar.php' ? 'active' : '' ?>" href="kullanicilar.php">
                        <i class="bi bi-people"></i> Kullanıcılar
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?= $current_page == 'projeler.php' ? 'active' : '' ?>" href="projeler.php">
