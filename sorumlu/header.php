<?php
// header.php - Sorumlu paneli için ortak başlık
if (!isset($_SESSION)) {
    session_start();
}

// Giriş kontrolü
if (!isset($_SESSION['giris']) || $_SESSION['giris'] !== true || $_SESSION['rol'] !== 'Sorumlu') {
...
<head>
    ...
    <title><?= $page_title ?? 'Sorumlu Paneli' ?> - Tedarik Portalı</title>
    ...
    <nav class="sidebar" id="sidebar">
        ...
        <div class="sidebar-sticky">
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link <?= $current_page == 'tedarikcilerim.php' ? 'active' : '' ?>" href="tedarikcilerim.php">
